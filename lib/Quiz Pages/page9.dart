...
import 'package:hpdeterminer/Quiz%20Pages/page10.dart';
      ...
      buttons: [
        ...
        DialogButton(
          ...
          gradient: LinearGradient(colors: [
            Color.fromRGBO(116, 116, 191, 100),
            Color.fromRGBO(52, 138, 199, 100)
          ]),
        )
      ],
    ).show();
                      ...
                      // width: 375,
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                              colors: [
                                Colors.redAccent.shade700, Colors.blue.shade900,
                              ]
                          ),
                  ...
                  child: BouncingWidget(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color : Color.fromRGBO(255, 86, 86, 100),
                      ),
                      child: Padding(
